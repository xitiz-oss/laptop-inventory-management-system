...
# display method to display all the available laptops in the selling interface
def display():
    ...
    print("| ITEM_NO \t|  AVAILABLE LAPTOPS IN SHOP \t| LAPTOP BRAND \t\t|  PRICE \t|  QUANTITY \t|  PROCESSOR \t| "
          "GRAPHICS IN LAPTOP  |")
    print("=" * 143)
    # iterating over the 2d list and unpacking it to display the laptops using format() to give a tabulated look
...
# if the input entered is "sys_exit" at any point of the program then the program ends
